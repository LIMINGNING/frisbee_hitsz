...
\begin{titlepage}
    ...
    % 顶部图片: 设置为铺满整个纸张宽度
    \noindent\hspace*{-1in}%
    \includegraphics[width=\paperwidth, height=0.4\paperheight, keepaspectratio]{2025极限飞盘赛大合照.jpg}%
...
\section{第三活动日赛果与积分排名 (截至11月4日)}

\subsection*{第三活动日 (11月4日) 赛果}
\begin{itemize}
    \item \textbf{第三轮小组赛:}
    \begin{itemize}
        \item A队 10 -- 8 C队
...
\subsection*{小组循环赛最终积分与排名 (截至11月4日第三轮赛后)}
\renewcommand{\arraystretch}{1.3}
\begin{tabularx}{\textwidth}{@{} M{1.2cm} M{1.2cm} M{1cm} M{1cm} M{1cm} M{1.2cm} M{1.5cm} M{1.5cm} M{1.5cm} @{}}
    \toprule
    \textbf{排名} & \textbf{队伍} & \textbf{场次} & \textbf{胜} & \textbf{负} & \textbf{积分} & \textbf{总得分} & \textbf{总失分} & \textbf{净胜分} \\
    \midrule
    1 & B队 & 3 & 3 & 0 & 6 & 31 & 12 & +19 \\
    2 & A队 & 3 & 2 & 1 & 4 & 21 & 21 & 0 \\
    3 & C队 & 3 & 1 & 2 & 2 & 23 & 24 & -1 \\
    4 & D队 & 3 & 0 & 3 & 0 & 10 & 28 & -18 \\
    \bottomrule
\end{tabularx}
\renewcommand{\arraystretch}{1.0}

\subsection*{半决赛对阵 (11月4日 19:55-20:45)}
根据小组循环赛最终排名，半决赛对阵安排如下：
\begin{itemize}
    \item \textbf{半决赛第7场 (场地1)：} 第1名 B队 (深) vs 第4名 D队 (浅)
    \item \textbf{半决赛第8场 (场地2)：} 第2名 A队 (深) vs 第3名 C队 (浅)
\end{itemize}

\vspace{0.5em}
\textit{注：半决赛获胜队伍将在11月11日争夺冠军，失败队伍将争夺季军。}
